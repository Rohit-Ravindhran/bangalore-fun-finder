  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b px-6 py-4 flex items-center gap-4">
        <Button variant="ghost" size="sm" onClick={() => navigate("/admin")} className="gap-1 text-gray-600">
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-5 flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2 mt-3">
                <Button size="sm" variant="outline" onClick={() => navigate("/admin/scraped-events")} className="border-green-300 text-green-800 hover:bg-green-100">
                  Review queue
                </Button>
