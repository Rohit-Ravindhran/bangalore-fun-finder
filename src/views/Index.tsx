...
const ActivityMapView = dynamic(() => import('@/components/ActivityMapView'), { ssr: false });
...
const Index = ({
  ...
  const { data: categories = initialCategories, isLoading: categoriesLoading } = useCategories();
