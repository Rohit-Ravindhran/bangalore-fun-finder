...
import { ArrowLeft, Sun, MapPin, Compass, Mountain, Trees } from 'lucide-react'
import BottomNav from '@/components/BottomNav'

const features = [
  { icon: Mountain, text: 'Weekend getaways within 100 km' },
  { icon: Trees, text: 'Nature trails and outdoor spots' },
  { icon: Compass, text: 'Adventure sports and activities' },
  { icon: MapPin, text: 'Temple circuits and heritage walks' },
]
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0D0D0F] pb-24">
      <header className="sticky top-0 z-40 bg-white dark:bg-[#0D0D0F] border-b border-gray-100 dark:border-white/[0.06] [transform:translateZ(0)]">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="font-semibold text-gray-900 dark:text-white">Day Out</h1>
          <div className="w-9" />
        </div>
      </header>
      ...
      <main className="px-4 py-10 max-w-md mx-auto">
        <div className="w-16 h-16 rounded-2xl bg-[#FFD60A]/10 border border-[#FFD60A]/20 flex items-center justify-center mx-auto mb-6">
          <Sun className="h-8 w-8 text-[#FFD60A]" />
        </div>
        ...
        <p className="text-sm text-center text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
          Discover fun ways to spend a full day out from Bangalore — gaming, nature, adventure, and everything in between.
        </p>
