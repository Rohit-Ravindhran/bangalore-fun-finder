...
function activitySlug(title, id) {
    ...
    return s ? "".concat(s, "-").concat(id) : String(id);
}
...
const decodeSession = (encoded)=>{
    try {
        ...
        if (session && typeof session.adminId === 'string' && typeof session.username === 'string' && typeof session.expiresAt === 'number') {
            return session;
        }
        return null;
    } catch (e) {
...
const AuthProvider = (param)=>{
    ...
    const [adminUsername, setAdminUsername] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const login = async (username, password)=>{
        ...
        if (lockout.locked) {
            return {
                success: false,
                message: "Too many failed attempts. Please try again in ".concat(lockout.remainingTime, " minutes.")
            };
        }
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('verify_admin_credentials', {
    ...
    const getAdminId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[getAdminId]": ()=>{
            const session = getCurrentSession();
            return (session === null || session === void 0 ? void 0 : session.adminId) || null;
        }
    }["AuthProvider.useCallback[getAdminId]"], []);
...
_s(AuthProvider, "CA91DV26jBr1TJywOvL0cOLQFBM=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
//# sourceMappingURL=src_52129094._.js.map