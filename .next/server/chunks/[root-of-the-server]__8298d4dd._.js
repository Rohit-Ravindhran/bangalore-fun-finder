module.exports = [
"[project]/.next-internal/server/app/api/admin/upload-image/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/upload-image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function adminClient() {
    const url = ("TURBOPACK compile-time value", "https://qphujgdfenhxyniidetd.supabase.co");
...
async function POST(req) {
    try {
        ...
        const { data, error: uploadError } = await supabase.storage.from(BUCKET).upload(fileName, bytes, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8298d4dd._.js.map